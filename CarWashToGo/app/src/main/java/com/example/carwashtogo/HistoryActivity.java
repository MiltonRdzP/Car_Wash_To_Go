...
public class HistoryActivity extends AppCompatActivity {
    ...
    private Double Balance = 60.0;

    private ImageView mPayoutEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(customerOrDriver.equals("CarWashMan")){
    ...
    private void payoutRequest() {
        ...
        progress.setTitle(R.string.pagoprocces);
        ...
        final Request request = new Request.Builder()
                .url("https://us-central1-car-wash-to-go-41334.cloudfunctions.net/payout")
                .post(body)
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response)
                ...
                if (response.isSuccessful())
                    switch (responseCode) {
                        case 200:
                            Snackbar.make(findViewById(R.id.layout), R.string.p1, Snackbar.LENGTH_LONG).show();
                            break;
                        case 501:
                            Snackbar.make(findViewById(R.id.layout), R.string.p2, Snackbar.LENGTH_LONG).show();
                            break;
                        default:
                            Snackbar.make(findViewById(R.id.layout), R.string.p3, Snackbar.LENGTH_LONG).show();
                            break;
                    }
                else
                    Snackbar.make(findViewById(R.id.layout), R.string.p1, Snackbar.LENGTH_LONG).show();
